                            ...
                            if (count === results.length) {
                                ...
                                for (var i = 0; i < detail.length; i++) {
                                    $("#reception > table > tbody").append("<tr>" +
                                        "<td><img src='" + results[i]["Poster"] + "'title = '"+results[i]["Title"]+"'</img ></td > "+"<td class='align-middle'>" + detail[i]["Ratings"][0]["Value"] + "</td>" +
                                ...
                                for (var i = 0; i < detail.length; i++) {
                                    $("#detail-view").append("<div class='collapse' id = '"+detail[i]["imdbID"]+"' > "+"<div class='card card-body'>" +
                                        "<h4>" + detail[i]["Title"] +
                                        " <span class='badge badge-dark'>" + detail[i]["Rated"] + "</span>" +
                                        " <span class='badge badge - secondary'>"+detail[i]["Runtime"]+"</span></h4>"+"<div class='container'><div class='row'>" +
                                        "<div class='col-lg-3 col-md-5 col-sm-6'>" +
                                        "<img src='" + detail[i]["Poster"] + "'title = '"+detail[i]["Title"]+"' ></img ></div > "+"<div class='col-lg-9 col-md-7 col-sm-6'>" +
                                        ...
                                        "<p><b>IMDb link: </b><a href = 'https://www.imdb.com/title/"+detail[i]["imdbID"]+"'>imdb.com/title/" + detail[i]["imdbID"] + "</a></p>" +
                                        "</div></div></div></div></div>");
                                }
