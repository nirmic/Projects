...
def get_player_actions():
    p1_sheet = SpriteSheet('./intermediate/images/p1_spritesheet.png')
    p1_file = open('./intermediate/images/p1_spritesheet.txt', 'r')
    p1_actions = {}
...
def init(p1_actions):
    ...
    for i in range(height // 100):
        for j in range(width // 420):
            plat = Platforms((random.randint(5, (width - 50) // 10) * 10,  120 * i), './intermediate/images/grassHalf.png', 70, 40)
            platforms.add(plat)
